...
class TestOperationsParameterized:
    """Parameterized tests for all operations to cover various input scenarios efficiently."""

    @pytest.mark.parametrize(
        "operation_class, symbol, name",
        [
            (Addition, "+", "addition"),
    ...
    def test_operation_properties(self, operation_class, symbol, name):
    ...
    def test_operation_calculations(self, operation_class, a, b, expected):
